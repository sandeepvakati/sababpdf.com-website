...
const MobileScan = () => {
    // In Next.js App Router, this would usually receive params if it was [sessionId]/page.jsx
    // Assuming we access it via route or props if refactored. Let's use useParams.
    const params = useParams();
    const sessionId = params?.sessionId; // We'll need a dynamic route for this
        ...
        <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center p-6 text-white text-center">
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="text-xs text-gray-500">
                    Session ID: <span className="font-mono text-gray-400">{sessionId || 'No session ID found'}</span>
                </div>
            </div>
        </div>
    );
