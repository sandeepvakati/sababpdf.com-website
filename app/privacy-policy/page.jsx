...
export const metadata = {
    ...
    description: 'Learn how SababPDF protects your privacy and data when using our free online PDF tools.',
};
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    If you have any questions about this Privacy Policy, please contact us at: sababpdf@gmail.com
                </p>
            </section>
        </div>
    );
