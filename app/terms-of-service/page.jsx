...
export const metadata = {
    ...
    description: 'Read the Terms of Service for using SababPDF, the online suite of free PDF tools.',
};
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    If you have any questions about these Terms, please contact us at: sababpdf@gmail.com
                </p>
            </section>
        </div>
    );
