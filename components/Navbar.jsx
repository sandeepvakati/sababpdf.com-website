...
const Navbar = () => {
    ...
    const tools = {
        organize: [
            { name: 'Merge PDF', href: '/merge-pdf', icon: Layers, color: 'text-red-500' },
            { name: 'Split PDF', href: '/split-pdf', icon: Scissors, color: 'text-green-500' },
        ],
        optimize: [
            ...
            { name: 'Signature Compressor', href: '/signature-compressor', icon: PenTool, color: 'text-purple-500' },
        ],
        convertToPdf: [
            { name: 'JPG to PDF', href: '/jpg-to-pdf', icon: Image, color: 'text-yellow-500' },
            { name: 'Word to PDF', href: '/word-to-pdf', icon: FileText, color: 'text-blue-600' },
            { name: 'Excel to PDF', href: '/excel-to-pdf', icon: FileSpreadsheet, color: 'text-green-600' },
            { name: 'PowerPoint to PDF', href: '/powerpoint-to-pdf', icon: Presentation, color: 'text-orange-600' },
            { name: 'HTML to PDF', href: '/html-to-pdf', icon: Globe, color: 'text-blue-600' },
        ],
        convertFromPdf: [
            { name: 'PDF to JPG', href: '/pdf-to-jpg', icon: FileImage, color: 'text-yellow-500' },
            { name: 'PDF to Word', href: '/pdf-to-word', icon: FileText, color: 'text-blue-600' },
            { name: 'PDF to Excel', href: '/pdf-to-excel', icon: FileSpreadsheet, color: 'text-green-600' },
            { name: 'PDF to PowerPoint', href: '/pdf-to-powerpoint', icon: Presentation, color: 'text-orange-600' },
        ],
        edit: [
            { name: 'Rotate PDF', href: '/rotate-pdf', icon: RotateCw, color: 'text-indigo-600' },
            { name: 'Add Page Numbers', href: '/add-page-numbers', icon: Hash, color: 'text-pink-600' },
            { name: 'Add Watermark', href: '/add-watermark', icon: Stamp, color: 'text-purple-600' },
            { name: 'Compare PDF', href: '/compare-pdf', icon: ArrowRightLeft, color: 'text-pink-500' },
        ],
        security: [
            { name: 'Redact PDF', href: '/redact-pdf', icon: FileBadge, color: 'text-gray-800' },
            { name: 'Protect PDF', href: '/protect-pdf', icon: Lock, color: 'text-emerald-600' },
            { name: 'Unlock PDF', href: '/unlock-pdf', icon: Unlock, color: 'text-cyan-600' },
        ]
    };
                ...
                <div className="flex justify-between h-16">
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:flex items-center space-x-1">
                                        ...
                                        <div>
                                            ...
                                            <ul className="space-y-2">
                                                {tools.organize.map(tool => (
                                                    <li key={tool.href}>
                                                        <Link href={tool.href} className="text-gray-600 hover:text-gray-900 text-sm flex items-center gap-3 group/item"><tool.icon className={`w-4 h-4 ${tool.color} transition-colors`} /><span>{tool.name}</span></Link>
                                                    </li>
                                                ))}
                                            </ul>
                            ...
                            <Link href="/merge-pdf" className="text-gray-700 hover:text-red-500 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                                Merge PDF
                            </Link>
                            <Link href="/split-pdf" className="text-gray-700 hover:text-red-500 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                                Split PDF
                            </Link>
                            <Link href="/compress-pdf" className="text-gray-700 hover:text-red-500 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                                Compress PDF
                            </Link>
                            <Link href="/blog" className="text-gray-700 hover:text-red-500 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                                Blog
                            </Link>
                        </div>
                    </div>
                        ...
                        {user ? (
                            ...
                            <>
                                <div className="hidden md:flex items-center space-x-2">
                                    <Link href="/login" className="text-gray-700 hover:text-gray-900 font-medium text-sm px-3 py-2">
                                        Log in
                                    </Link>
                                    <Link href="/signup" className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm hover:shadow-md">
                                        Sign up
                                    </Link>
                                </div>
