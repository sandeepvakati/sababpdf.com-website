...
const FeatureCard = ({ title, description, icon: Icon, to, color }) => {
    return (
        <Link to={to} className="group bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 border border-gray-100 hover:border-black block h-full">
